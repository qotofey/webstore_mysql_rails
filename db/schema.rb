...
ActiveRecord::Schema.define(version: 2022_03_09_184450) do
  ...
  create_table "category_fields", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["category_id", "slug"], name: "index_category_fields_on_category_id_and_slug", unique: true
  ...
  create_table "user_roles", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id", "position"], name: "index_user_roles_on_user_id_and_position", unique: true
